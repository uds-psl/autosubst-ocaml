...
Definition congr_arr {s0 : ty} {s1 : ty} {t0 : ty} {t1 : ty} (H0 : s0 = t0)
  (H1 : s1 = t1) : arr s0 s1 = arr t0 t1 :=
  eq_trans (eq_trans eq_refl (ap (fun x => arr x s1) H0))
    (ap (fun x => arr t0 x) H1).

Definition congr_all {s0 : ty} {t0 : ty} (H0 : s0 = t0) : all s0 = all t0 :=
  eq_trans eq_refl (ap (fun x => all x) H0).
...
Definition rinstInst_ty (xi_ty : nat -> nat) :
...
Definition compComp'_ty (sigma_ty : nat -> ty) (tau_ty : nat -> ty) :
...
Definition congr_tapp {s0 : tm} {s1 : ty} {t0 : tm} {t1 : ty} (H0 : s0 = t0)
  (H1 : s1 = t1) : tapp s0 s1 = tapp t0 t1 :=
  eq_trans (eq_trans eq_refl (ap (fun x => tapp x s1) H0))
    (ap (fun x => tapp t0 x) H1).

Definition congr_vt {s0 : vl} {t0 : vl} (H0 : s0 = t0) : vt s0 = vt t0 :=
  eq_trans eq_refl (ap (fun x => vt x) H0).

Definition congr_lam {s0 : ty} {s1 : tm} {t0 : ty} {t1 : tm} (H0 : s0 = t0)
  (H1 : s1 = t1) : lam s0 s1 = lam t0 t1 :=
  eq_trans (eq_trans eq_refl (ap (fun x => lam x s1) H0))
    (ap (fun x => lam t0 x) H1).

Definition congr_tlam {s0 : tm} {t0 : tm} (H0 : s0 = t0) :
  tlam s0 = tlam t0 := eq_trans eq_refl (ap (fun x => tlam x) H0).
...
Definition rinstInst_tm (xi_ty : nat -> nat) (xi_vl : nat -> nat) :
...
Definition rinstInst_vl (xi_ty : nat -> nat) (xi_vl : nat -> nat) :
...
Definition instId_tm : subst_tm var_ty var_vl = id :=
  FunctionalExtensionality.functional_extensionality _ _
    (fun x =>
     idSubst_tm var_ty var_vl (fun n => eq_refl) (fun n => eq_refl) (id x)).

Definition instId_vl : subst_vl var_ty var_vl = id :=
  FunctionalExtensionality.functional_extensionality _ _
    (fun x =>
     idSubst_vl var_ty var_vl (fun n => eq_refl) (fun n => eq_refl) (id x)).

Definition rinstId_tm : @ren_tm id id = id :=
  eq_trans (rinstInst_tm (id _) (id _)) instId_tm.

Definition rinstId_vl : @ren_vl id id = id :=
  eq_trans (rinstInst_vl (id _) (id _)) instId_vl.

Definition varL_vl (sigma_ty : nat -> ty) (sigma_vl : nat -> vl) :
  funcomp (subst_vl sigma_ty sigma_vl) var_vl = sigma_vl :=
  FunctionalExtensionality.functional_extensionality _ _ (fun x => eq_refl).

Definition varLRen_vl (xi_ty : nat -> nat) (xi_vl : nat -> nat) :
  funcomp (ren_vl xi_ty xi_vl) var_vl = funcomp var_vl xi_vl :=
  FunctionalExtensionality.functional_extensionality _ _ (fun x => eq_refl).

Definition renRen_tm (xi_ty : nat -> nat) (xi_vl : nat -> nat)
...
Definition renRen'_tm (xi_ty : nat -> nat) (xi_vl : nat -> nat)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) :
...
Definition renRen_vl (xi_ty : nat -> nat) (xi_vl : nat -> nat)
...
Definition renRen'_vl (xi_ty : nat -> nat) (xi_vl : nat -> nat)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) :
...
Definition compRen_tm (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) (s : tm) :
  ren_tm zeta_ty zeta_vl (subst_tm sigma_ty sigma_vl s) =
...
Definition compRen'_tm (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) :
...
Definition compRen_vl (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) (s : vl) :
  ren_vl zeta_ty zeta_vl (subst_vl sigma_ty sigma_vl s) =
...
Definition compRen'_vl (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) :
...
Definition renComp_tm (xi_ty : nat -> nat) (xi_vl : nat -> nat)
...
Definition renComp'_tm (xi_ty : nat -> nat) (xi_vl : nat -> nat)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
...
Definition renComp_vl (xi_ty : nat -> nat) (xi_vl : nat -> nat)
...
Definition renComp'_vl (xi_ty : nat -> nat) (xi_vl : nat -> nat)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
...
Definition compComp_tm (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) (s : tm) :
  subst_tm tau_ty tau_vl (subst_tm sigma_ty sigma_vl s) =
...
Definition compComp'_tm (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
...
Definition compComp_vl (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) (s : vl) :
  subst_vl tau_ty tau_vl (subst_vl sigma_ty sigma_vl s) =
...
Definition compComp'_vl (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
