...
Definition congr_app {m_tm : nat} {s0 : tm m_tm} {s1 : tm m_tm}
  {t0 : tm m_tm} {t1 : tm m_tm} (H0 : s0 = t0) (H1 : s1 = t1) :
  app m_tm s0 s1 = app m_tm t0 t1 :=
  eq_trans (eq_trans eq_refl (ap (fun x => app m_tm x s1) H0))
    (ap (fun x => app m_tm t0 x) H1).

Definition congr_lam {m_tm : nat} {s0 : tm (S m_tm)} {t0 : tm (S m_tm)}
  (H0 : s0 = t0) : lam m_tm s0 = lam m_tm t0 :=
  eq_trans eq_refl (ap (fun x => lam m_tm x) H0).

Definition congr_pair {m_tm : nat} {s0 : tm m_tm} {s1 : tm m_tm}
  {t0 : tm m_tm} {t1 : tm m_tm} (H0 : s0 = t0) (H1 : s1 = t1) :
  pair m_tm s0 s1 = pair m_tm t0 t1 :=
  eq_trans (eq_trans eq_refl (ap (fun x => pair m_tm x s1) H0))
    (ap (fun x => pair m_tm t0 x) H1).

Definition congr_matchpair {m_tm : nat} {s0 : tm m_tm} {s1 : tm (S (S m_tm))}
  {t0 : tm m_tm} {t1 : tm (S (S m_tm))} (H0 : s0 = t0) (H1 : s1 = t1) :
  matchpair m_tm s0 s1 = matchpair m_tm t0 t1 :=
  eq_trans (eq_trans eq_refl (ap (fun x => matchpair m_tm x s1) H0))
...
Definition rinstInst_tm {m_tm : nat} {n_tm : nat}
...
Definition compRen'_tm {k_tm : nat} {l_tm : nat} {m_tm : nat}
  (sigma_tm : fin m_tm -> tm k_tm) (zeta_tm : fin k_tm -> fin l_tm) :
...
Definition renComp_tm {k_tm : nat} {l_tm : nat} {m_tm : nat}
...
Definition renComp'_tm {k_tm : nat} {l_tm : nat} {m_tm : nat}
  (xi_tm : fin m_tm -> fin k_tm) (tau_tm : fin k_tm -> tm l_tm) :
  funcomp (subst_tm tau_tm) (ren_tm xi_tm) = subst_tm (funcomp tau_tm xi_tm) :=
  FunctionalExtensionality.functional_extensionality _ _
    (fun n => renComp_tm xi_tm tau_tm n).

Definition compComp_tm {k_tm : nat} {l_tm : nat} {m_tm : nat}
  (sigma_tm : fin m_tm -> tm k_tm) (tau_tm : fin k_tm -> tm l_tm)
  (s : tm m_tm) :
...
Definition compComp'_tm {k_tm : nat} {l_tm : nat} {m_tm : nat}
  (sigma_tm : fin m_tm -> tm k_tm) (tau_tm : fin k_tm -> tm l_tm) :
