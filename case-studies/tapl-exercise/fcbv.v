...
exact (FunctionalExtensionality.functional_extensionality _ _
         (fun x =>
          idSubst_tm (var_ty) (var_vl) (fun n => eq_refl) (fun n => eq_refl)
            (id x))).
Qed.
...
exact (FunctionalExtensionality.functional_extensionality _ _
         (fun x =>
          idSubst_vl (var_ty) (var_vl) (fun n => eq_refl) (fun n => eq_refl)
            (id x))).
Qed.
...
Lemma substRen'_tm (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) :
...
Lemma substRen'_vl (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (zeta_ty : nat -> nat) (zeta_vl : nat -> nat) :
...
Lemma renSubst'_tm (xi_ty : nat -> nat) (xi_vl : nat -> nat)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
...
Lemma renSubst'_vl (xi_ty : nat -> nat) (xi_vl : nat -> nat)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
...
Lemma substSubst'_tm (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
...
Lemma substSubst'_vl (sigma_ty : nat -> ty) (sigma_vl : nat -> vl)
  (tau_ty : nat -> ty) (tau_vl : nat -> vl) :
...
Ltac asimpl_fext' := repeat (first
                      ...
                      | progress
                         unfold up_vl_vl, up_vl_ty, up_ty_vl, upRen_vl_vl,
                          upRen_vl_ty, upRen_ty_vl, up_ty_ty, upRen_ty_ty,
                          up_ren
                      | progress
                         cbn[subst_vl subst_tm ren_vl ren_tm subst_ty ren_ty]
                      | fsimpl_fext ]).
