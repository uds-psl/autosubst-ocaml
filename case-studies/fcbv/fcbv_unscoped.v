...
Lemma congr_arr {s0 : ty} {s1 : ty} {t0 : ty} {t1 : ty} (H0 : eq s0 t0)
  (H1 : eq s1 t1) : eq (arr s0 s1) (arr t0 t1).
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => arr x s1) H0))
                (ap (fun x => arr t0 x) H1)).
Qed.
Lemma congr_all {s0 : ty} {t0 : ty} (H0 : eq s0 t0) : eq (all s0) (all t0).
Proof.
exact (eq_trans eq_refl (ap (fun x => all x) H0)).
Qed.
Definition upRen_ty_ty (xi : forall _ : nat, nat) : forall _ : nat, nat :=
  up_ren xi.
Fixpoint ren_ty (xi_ty : forall _ : nat, nat) (s : ty) : ty :=
  match s with
  | var_ty s0 => var_ty (xi_ty s0)
  | arr s0 s1 => arr (ren_ty xi_ty s0) (ren_ty xi_ty s1)
  | all s0 => all (ren_ty (upRen_ty_ty xi_ty) s0)
  end.
Definition up_ty_ty (sigma : forall _ : nat, ty) : forall _ : nat, ty :=
  scons (var_ty var_zero) (funcomp (ren_ty shift) sigma).
Fixpoint subst_ty (sigma_ty : forall _ : nat, ty) (s : ty) : ty :=
  match s with
  | var_ty s0 => sigma_ty s0
  | arr s0 s1 => arr (subst_ty sigma_ty s0) (subst_ty sigma_ty s1)
  | all s0 => all (subst_ty (up_ty_ty sigma_ty) s0)
  end.
Definition upId_ty_ty (sigma : forall _ : nat, ty)
  (Eq : forall x, eq (sigma x) (var_ty x)) :
  forall x, eq (up_ty_ty sigma x) (var_ty x) :=
  fun n =>
  match n with
  | S n' => ap (ren_ty shift) (Eq n')
  | O => eq_refl
  end.
Fixpoint idSubst_ty (sigma_ty : forall _ : nat, ty)
(Eq_ty : forall x, eq (sigma_ty x) (var_ty x)) (s : ty) :
...
Definition upExtRen_ty_ty (xi : forall _ : nat, nat)
...
Fixpoint extRen_ty (xi_ty : forall _ : nat, nat)
(zeta_ty : forall _ : nat, nat) (Eq_ty : forall x, eq (xi_ty x) (zeta_ty x))
...
Definition upExt_ty_ty (sigma : forall _ : nat, ty)
  (tau : forall _ : nat, ty) (Eq : forall x, eq (sigma x) (tau x)) :
...
Fixpoint ext_ty (sigma_ty : forall _ : nat, ty) (tau_ty : forall _ : nat, ty)
...
Definition up_ren_ren_ty_ty (xi : forall _ : nat, nat)
...
Fixpoint compRenRen_ty (xi_ty : forall _ : nat, nat)
(zeta_ty : forall _ : nat, nat) (rho_ty : forall _ : nat, nat)
...
Definition up_ren_subst_ty_ty (xi : forall _ : nat, nat)
  (tau : forall _ : nat, ty) (theta : forall _ : nat, ty)
...
Fixpoint compRenSubst_ty (xi_ty : forall _ : nat, nat)
(tau_ty : forall _ : nat, ty) (theta_ty : forall _ : nat, ty)
...
Definition up_subst_ren_ty_ty (sigma : forall _ : nat, ty)
  (zeta_ty : forall _ : nat, nat) (theta : forall _ : nat, ty)
...
Fixpoint compSubstRen_ty (sigma_ty : forall _ : nat, ty)
(zeta_ty : forall _ : nat, nat) (theta_ty : forall _ : nat, ty)
...
Definition up_subst_subst_ty_ty (sigma : forall _ : nat, ty)
  (tau_ty : forall _ : nat, ty) (theta : forall _ : nat, ty)
...
Fixpoint compSubstSubst_ty (sigma_ty : forall _ : nat, ty)
(tau_ty : forall _ : nat, ty) (theta_ty : forall _ : nat, ty)
...
Definition rinstInst_up_ty_ty (xi : forall _ : nat, nat)
  (sigma : forall _ : nat, ty)
  (Eq : forall x, eq (funcomp var_ty xi x) (sigma x)) :
  forall x, eq (funcomp var_ty (upRen_ty_ty xi) x) (up_ty_ty sigma x) :=
  fun n =>
  match n with
  | S n' => ap (ren_ty shift) (Eq n')
  | O => eq_refl
  end.
Fixpoint rinst_inst_ty (xi_ty : forall _ : nat, nat)
(sigma_ty : forall _ : nat, ty)
(Eq_ty : forall x, eq (funcomp var_ty xi_ty x) (sigma_ty x)) (s : ty) :
...
Lemma rinstInst_ty (xi_ty : forall _ : nat, nat) :
  eq (ren_ty xi_ty) (subst_ty (funcomp var_ty xi_ty)).
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x => rinst_inst_ty xi_ty _ (fun n => eq_refl) x)).
Qed.
Lemma instId_ty : eq (subst_ty var_ty) id.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x => idSubst_ty var_ty (fun n => eq_refl) (id x))).
Qed.
Lemma rinstId_ty : eq (@ren_ty id) id.
Proof.
exact (eq_trans (rinstInst_ty (id _)) instId_ty).
Qed.
Lemma varL_ty (sigma_ty : forall _ : nat, ty) :
  eq (funcomp (subst_ty sigma_ty) var_ty) sigma_ty.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x => eq_refl)).
Qed.
Lemma varLRen_ty (xi_ty : forall _ : nat, nat) :
  eq (funcomp (ren_ty xi_ty) var_ty) (funcomp var_ty xi_ty).
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x => eq_refl)).
Qed.
Lemma renRen_ty (xi_ty : forall _ : nat, nat) (zeta_ty : forall _ : nat, nat)
  (s : ty) :
  eq (ren_ty zeta_ty (ren_ty xi_ty s)) (ren_ty (funcomp zeta_ty xi_ty) s).
Proof.
exact (compRenRen_ty xi_ty zeta_ty _ (fun n => eq_refl) s).
Qed.
Lemma renRen'_ty (xi_ty : forall _ : nat, nat)
  (zeta_ty : forall _ : nat, nat) :
...
Qed.
Lemma compRen_ty (sigma_ty : forall _ : nat, ty)
  (zeta_ty : forall _ : nat, nat) (s : ty) :
...
Qed.
Lemma compRen'_ty (sigma_ty : forall _ : nat, ty)
  (zeta_ty : forall _ : nat, nat) :
...
Qed.
Lemma renComp_ty (xi_ty : forall _ : nat, nat) (tau_ty : forall _ : nat, ty)
  (s : ty) :
  eq (subst_ty tau_ty (ren_ty xi_ty s)) (subst_ty (funcomp tau_ty xi_ty) s).
Proof.
exact (compRenSubst_ty xi_ty tau_ty _ (fun n => eq_refl) s).
Qed.
Lemma renComp'_ty (xi_ty : forall _ : nat, nat) (tau_ty : forall _ : nat, ty)
  :
...
Qed.
Lemma compComp_ty (sigma_ty : forall _ : nat, ty)
  (tau_ty : forall _ : nat, ty) (s : ty) :
...
Qed.
Lemma compComp'_ty (sigma_ty : forall _ : nat, ty)
  (tau_ty : forall _ : nat, ty) :
...
Lemma congr_tapp {s0 : tm} {s1 : ty} {t0 : tm} {t1 : ty} (H0 : eq s0 t0)
  (H1 : eq s1 t1) : eq (tapp s0 s1) (tapp t0 t1).
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => tapp x s1) H0))
                (ap (fun x => tapp t0 x) H1)).
Qed.
Lemma congr_vt {s0 : vl} {t0 : vl} (H0 : eq s0 t0) : eq (vt s0) (vt t0).
Proof.
...
Qed.
Lemma congr_tlam {s0 : tm} {t0 : tm} (H0 : eq s0 t0) : eq (tlam s0) (tlam t0).
Proof.
exact (eq_trans eq_refl (ap (fun x => tlam x) H0)).
Qed.
Definition upRen_ty_vl (xi : forall _ : nat, nat) : forall _ : nat, nat := xi.
Definition upRen_vl_ty (xi : forall _ : nat, nat) : forall _ : nat, nat := xi.
Definition upRen_vl_vl (xi : forall _ : nat, nat) : forall _ : nat, nat :=
  up_ren xi.
Fixpoint ren_tm (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
(s : tm) : tm :=
  match s with
...
with ren_vl (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
(s : vl) : vl :=
  match s with
...
Definition up_ty_vl (sigma : forall _ : nat, vl) : forall _ : nat, vl :=
  funcomp (ren_vl shift id) sigma.
Definition up_vl_ty (sigma : forall _ : nat, ty) : forall _ : nat, ty :=
  funcomp (ren_ty id) sigma.
Definition up_vl_vl (sigma : forall _ : nat, vl) : forall _ : nat, vl :=
  scons (var_vl var_zero) (funcomp (ren_vl id shift) sigma).
Fixpoint subst_tm (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl) (s : tm) : tm :=
  match s with
  | app s0 s1 =>
...
with subst_vl (sigma_ty : forall _ : nat, ty) (sigma_vl : forall _ : nat, vl)
(s : vl) : vl :=
  match s with
...
Definition upId_ty_vl (sigma : forall _ : nat, vl)
  (Eq : forall x, eq (sigma x) (var_vl x)) :
  forall x, eq (up_ty_vl sigma x) (var_vl x) :=
  fun n => ap (ren_vl shift id) (Eq n).
Definition upId_vl_ty (sigma : forall _ : nat, ty)
  (Eq : forall x, eq (sigma x) (var_ty x)) :
  forall x, eq (up_vl_ty sigma x) (var_ty x) :=
  fun n => ap (ren_ty id) (Eq n).
Definition upId_vl_vl (sigma : forall _ : nat, vl)
  (Eq : forall x, eq (sigma x) (var_vl x)) :
  forall x, eq (up_vl_vl sigma x) (var_vl x) :=
  fun n =>
  match n with
  | S n' => ap (ren_vl id shift) (Eq n')
  | O => eq_refl
  end.
Fixpoint idSubst_tm (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (sigma_ty x) (var_ty x))
(Eq_vl : forall x, eq (sigma_vl x) (var_vl x)) (s : tm) :
...
with idSubst_vl (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (sigma_ty x) (var_ty x))
(Eq_vl : forall x, eq (sigma_vl x) (var_vl x)) (s : vl) :
...
Definition upExtRen_ty_vl (xi : forall _ : nat, nat)
  (zeta : forall _ : nat, nat) (Eq : forall x, eq (xi x) (zeta x)) :
  forall x, eq (upRen_ty_vl xi x) (upRen_ty_vl zeta x) := fun n => Eq n.
Definition upExtRen_vl_ty (xi : forall _ : nat, nat)
  (zeta : forall _ : nat, nat) (Eq : forall x, eq (xi x) (zeta x)) :
  forall x, eq (upRen_vl_ty xi x) (upRen_vl_ty zeta x) := fun n => Eq n.
Definition upExtRen_vl_vl (xi : forall _ : nat, nat)
  (zeta : forall _ : nat, nat) (Eq : forall x, eq (xi x) (zeta x)) :
...
Fixpoint extRen_tm (xi_ty : forall _ : nat, nat)
(xi_vl : forall _ : nat, nat) (zeta_ty : forall _ : nat, nat)
(zeta_vl : forall _ : nat, nat) (Eq_ty : forall x, eq (xi_ty x) (zeta_ty x))
...
with extRen_vl (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
(zeta_ty : forall _ : nat, nat) (zeta_vl : forall _ : nat, nat)
...
Definition upExt_ty_vl (sigma : forall _ : nat, vl)
  (tau : forall _ : nat, vl) (Eq : forall x, eq (sigma x) (tau x)) :
  forall x, eq (up_ty_vl sigma x) (up_ty_vl tau x) :=
  fun n => ap (ren_vl shift id) (Eq n).
Definition upExt_vl_ty (sigma : forall _ : nat, ty)
  (tau : forall _ : nat, ty) (Eq : forall x, eq (sigma x) (tau x)) :
  forall x, eq (up_vl_ty sigma x) (up_vl_ty tau x) :=
  fun n => ap (ren_ty id) (Eq n).
Definition upExt_vl_vl (sigma : forall _ : nat, vl)
  (tau : forall _ : nat, vl) (Eq : forall x, eq (sigma x) (tau x)) :
...
Fixpoint ext_tm (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl) (tau_ty : forall _ : nat, ty)
(tau_vl : forall _ : nat, vl) (Eq_ty : forall x, eq (sigma_ty x) (tau_ty x))
...
with ext_vl (sigma_ty : forall _ : nat, ty) (sigma_vl : forall _ : nat, vl)
(tau_ty : forall _ : nat, ty) (tau_vl : forall _ : nat, vl)
...
Definition up_ren_ren_ty_vl (xi : forall _ : nat, nat)
  (zeta : forall _ : nat, nat) (rho : forall _ : nat, nat)
  (Eq : forall x, eq (funcomp zeta xi x) (rho x)) :
  forall x,
  eq (funcomp (upRen_ty_vl zeta) (upRen_ty_vl xi) x) (upRen_ty_vl rho x) :=
  Eq.
Definition up_ren_ren_vl_ty (xi : forall _ : nat, nat)
  (zeta : forall _ : nat, nat) (rho : forall _ : nat, nat)
  (Eq : forall x, eq (funcomp zeta xi x) (rho x)) :
  forall x,
  eq (funcomp (upRen_vl_ty zeta) (upRen_vl_ty xi) x) (upRen_vl_ty rho x) :=
  Eq.
Definition up_ren_ren_vl_vl (xi : forall _ : nat, nat)
  (zeta : forall _ : nat, nat) (rho : forall _ : nat, nat)
  (Eq : forall x, eq (funcomp zeta xi x) (rho x)) :
  forall x,
  eq (funcomp (upRen_vl_vl zeta) (upRen_vl_vl xi) x) (upRen_vl_vl rho x) :=
  up_ren_ren xi zeta rho Eq.
Fixpoint compRenRen_tm (xi_ty : forall _ : nat, nat)
(xi_vl : forall _ : nat, nat) (zeta_ty : forall _ : nat, nat)
(zeta_vl : forall _ : nat, nat) (rho_ty : forall _ : nat, nat)
(rho_vl : forall _ : nat, nat)
...
with compRenRen_vl (xi_ty : forall _ : nat, nat)
(xi_vl : forall _ : nat, nat) (zeta_ty : forall _ : nat, nat)
(zeta_vl : forall _ : nat, nat) (rho_ty : forall _ : nat, nat)
(rho_vl : forall _ : nat, nat)
(Eq_ty : forall x, eq (funcomp zeta_ty xi_ty x) (rho_ty x))
...
Definition up_ren_subst_ty_vl (xi : forall _ : nat, nat)
  (tau : forall _ : nat, vl) (theta : forall _ : nat, vl)
  (Eq : forall x, eq (funcomp tau xi x) (theta x)) :
  forall x, eq (funcomp (up_ty_vl tau) (upRen_ty_vl xi) x) (up_ty_vl theta x) :=
  fun n => ap (ren_vl shift id) (Eq n).
Definition up_ren_subst_vl_ty (xi : forall _ : nat, nat)
  (tau : forall _ : nat, ty) (theta : forall _ : nat, ty)
  (Eq : forall x, eq (funcomp tau xi x) (theta x)) :
  forall x, eq (funcomp (up_vl_ty tau) (upRen_vl_ty xi) x) (up_vl_ty theta x) :=
  fun n => ap (ren_ty id) (Eq n).
Definition up_ren_subst_vl_vl (xi : forall _ : nat, nat)
  (tau : forall _ : nat, vl) (theta : forall _ : nat, vl)
  (Eq : forall x, eq (funcomp tau xi x) (theta x)) :
...
Fixpoint compRenSubst_tm (xi_ty : forall _ : nat, nat)
(xi_vl : forall _ : nat, nat) (tau_ty : forall _ : nat, ty)
(tau_vl : forall _ : nat, vl) (theta_ty : forall _ : nat, ty)
(theta_vl : forall _ : nat, vl)
...
with compRenSubst_vl (xi_ty : forall _ : nat, nat)
(xi_vl : forall _ : nat, nat) (tau_ty : forall _ : nat, ty)
(tau_vl : forall _ : nat, vl) (theta_ty : forall _ : nat, ty)
(theta_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (funcomp tau_ty xi_ty x) (theta_ty x))
...
Definition up_subst_ren_ty_vl (sigma : forall _ : nat, vl)
  (zeta_ty : forall _ : nat, nat) (zeta_vl : forall _ : nat, nat)
  (theta : forall _ : nat, vl)
...
Definition up_subst_ren_vl_ty (sigma : forall _ : nat, ty)
  (zeta_ty : forall _ : nat, nat) (theta : forall _ : nat, ty)
  (Eq : forall x, eq (funcomp (ren_ty zeta_ty) sigma x) (theta x)) :
  forall x,
...
Definition up_subst_ren_vl_vl (sigma : forall _ : nat, vl)
  (zeta_ty : forall _ : nat, nat) (zeta_vl : forall _ : nat, nat)
  (theta : forall _ : nat, vl)
  (Eq : forall x, eq (funcomp (ren_vl zeta_ty zeta_vl) sigma x) (theta x)) :
  forall x,
...
Fixpoint compSubstRen_tm (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl) (zeta_ty : forall _ : nat, nat)
(zeta_vl : forall _ : nat, nat) (theta_ty : forall _ : nat, ty)
(theta_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (funcomp (ren_ty zeta_ty) sigma_ty x) (theta_ty x))
(Eq_vl : forall x,
...
with compSubstRen_vl (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl) (zeta_ty : forall _ : nat, nat)
(zeta_vl : forall _ : nat, nat) (theta_ty : forall _ : nat, ty)
(theta_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (funcomp (ren_ty zeta_ty) sigma_ty x) (theta_ty x))
...
Definition up_subst_subst_ty_vl (sigma : forall _ : nat, vl)
  (tau_ty : forall _ : nat, ty) (tau_vl : forall _ : nat, vl)
  (theta : forall _ : nat, vl)
...
Definition up_subst_subst_vl_ty (sigma : forall _ : nat, ty)
  (tau_ty : forall _ : nat, ty) (theta : forall _ : nat, ty)
  (Eq : forall x, eq (funcomp (subst_ty tau_ty) sigma x) (theta x)) :
  forall x,
...
Definition up_subst_subst_vl_vl (sigma : forall _ : nat, vl)
  (tau_ty : forall _ : nat, ty) (tau_vl : forall _ : nat, vl)
  (theta : forall _ : nat, vl)
  (Eq : forall x, eq (funcomp (subst_vl tau_ty tau_vl) sigma x) (theta x)) :
  forall x,
...
Fixpoint compSubstSubst_tm (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl) (tau_ty : forall _ : nat, ty)
(tau_vl : forall _ : nat, vl) (theta_ty : forall _ : nat, ty)
(theta_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (funcomp (subst_ty tau_ty) sigma_ty x) (theta_ty x))
...
with compSubstSubst_vl (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl) (tau_ty : forall _ : nat, ty)
(tau_vl : forall _ : nat, vl) (theta_ty : forall _ : nat, ty)
(theta_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (funcomp (subst_ty tau_ty) sigma_ty x) (theta_ty x))
...
Definition rinstInst_up_ty_vl (xi : forall _ : nat, nat)
  (sigma : forall _ : nat, vl)
  (Eq : forall x, eq (funcomp var_vl xi x) (sigma x)) :
  forall x, eq (funcomp var_vl (upRen_ty_vl xi) x) (up_ty_vl sigma x) :=
  fun n => ap (ren_vl shift id) (Eq n).
Definition rinstInst_up_vl_ty (xi : forall _ : nat, nat)
  (sigma : forall _ : nat, ty)
  (Eq : forall x, eq (funcomp var_ty xi x) (sigma x)) :
  forall x, eq (funcomp var_ty (upRen_vl_ty xi) x) (up_vl_ty sigma x) :=
  fun n => ap (ren_ty id) (Eq n).
Definition rinstInst_up_vl_vl (xi : forall _ : nat, nat)
  (sigma : forall _ : nat, vl)
  (Eq : forall x, eq (funcomp var_vl xi x) (sigma x)) :
  forall x, eq (funcomp var_vl (upRen_vl_vl xi) x) (up_vl_vl sigma x) :=
  fun n =>
  match n with
  | S n' => ap (ren_vl id shift) (Eq n')
  | O => eq_refl
  end.
Fixpoint rinst_inst_tm (xi_ty : forall _ : nat, nat)
(xi_vl : forall _ : nat, nat) (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (funcomp var_ty xi_ty x) (sigma_ty x))
(Eq_vl : forall x, eq (funcomp var_vl xi_vl x) (sigma_vl x)) (s : tm) :
eq (ren_tm xi_ty xi_vl s) (subst_tm sigma_ty sigma_vl s) :=
  match s with
  | app s0 s1 =>
...
with rinst_inst_vl (xi_ty : forall _ : nat, nat)
(xi_vl : forall _ : nat, nat) (sigma_ty : forall _ : nat, ty)
(sigma_vl : forall _ : nat, vl)
(Eq_ty : forall x, eq (funcomp var_ty xi_ty x) (sigma_ty x))
(Eq_vl : forall x, eq (funcomp var_vl xi_vl x) (sigma_vl x)) (s : vl) :
eq (ren_vl xi_ty xi_vl s) (subst_vl sigma_ty sigma_vl s) :=
  match s with
  | var_vl s0 => Eq_vl s0
  | lam s0 s1 =>
...
Lemma rinstInst_tm (xi_ty : forall _ : nat, nat)
  (xi_vl : forall _ : nat, nat) :
...
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x =>
                 rinst_inst_tm xi_ty xi_vl _ _ (fun n => eq_refl)
                   (fun n => eq_refl) x)).
Qed.
Lemma rinstInst_vl (xi_ty : forall _ : nat, nat)
  (xi_vl : forall _ : nat, nat) :
...
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x =>
                 rinst_inst_vl xi_ty xi_vl _ _ (fun n => eq_refl)
                   (fun n => eq_refl) x)).
Qed.
Lemma instId_tm : eq (subst_tm var_ty var_vl) id.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x =>
                 idSubst_tm var_ty var_vl (fun n => eq_refl)
                   (fun n => eq_refl) (id x))).
Qed.
Lemma instId_vl : eq (subst_vl var_ty var_vl) id.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x =>
                 idSubst_vl var_ty var_vl (fun n => eq_refl)
                   (fun n => eq_refl) (id x))).
Qed.
Lemma rinstId_tm : eq (@ren_tm id id) id.
Proof.
exact (eq_trans (rinstInst_tm (id _) (id _)) instId_tm).
Qed.
Lemma rinstId_vl : eq (@ren_vl id id) id.
Proof.
exact (eq_trans (rinstInst_vl (id _) (id _)) instId_vl).
Qed.
Lemma varL_vl (sigma_ty : forall _ : nat, ty) (sigma_vl : forall _ : nat, vl)
  : eq (funcomp (subst_vl sigma_ty sigma_vl) var_vl) sigma_vl.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x => eq_refl)).
Qed.
Lemma varLRen_vl (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  : eq (funcomp (ren_vl xi_ty xi_vl) var_vl) (funcomp var_vl xi_vl).
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
                (fun x => eq_refl)).
Qed.
Lemma renRen_tm (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (zeta_ty : forall _ : nat, nat) (zeta_vl : forall _ : nat, nat) (s : tm) :
...
Qed.
Lemma renRen'_tm (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (zeta_ty : forall _ : nat, nat) (zeta_vl : forall _ : nat, nat) :
...
Qed.
Lemma renRen_vl (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (zeta_ty : forall _ : nat, nat) (zeta_vl : forall _ : nat, nat) (s : vl) :
...
exact (compRenRen_vl xi_ty xi_vl zeta_ty zeta_vl _ _
                (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
Lemma renRen'_vl (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (zeta_ty : forall _ : nat, nat) (zeta_vl : forall _ : nat, nat) :
...
Qed.
Lemma compRen_tm (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (zeta_ty : forall _ : nat, nat)
  (zeta_vl : forall _ : nat, nat) (s : tm) :
  eq (ren_tm zeta_ty zeta_vl (subst_tm sigma_ty sigma_vl s))
...
exact (compSubstRen_tm sigma_ty sigma_vl zeta_ty zeta_vl _ _
                (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
Lemma compRen'_tm (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (zeta_ty : forall _ : nat, nat)
  (zeta_vl : forall _ : nat, nat) :
...
Qed.
Lemma compRen_vl (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (zeta_ty : forall _ : nat, nat)
  (zeta_vl : forall _ : nat, nat) (s : vl) :
  eq (ren_vl zeta_ty zeta_vl (subst_vl sigma_ty sigma_vl s))
...
exact (compSubstRen_vl sigma_ty sigma_vl zeta_ty zeta_vl _ _
                (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
Lemma compRen'_vl (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (zeta_ty : forall _ : nat, nat)
  (zeta_vl : forall _ : nat, nat) :
...
Qed.
Lemma renComp_tm (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (tau_ty : forall _ : nat, ty) (tau_vl : forall _ : nat, vl) (s : tm) :
  eq (subst_tm tau_ty tau_vl (ren_tm xi_ty xi_vl s))
...
exact (compRenSubst_tm xi_ty xi_vl tau_ty tau_vl _ _
                (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
Lemma renComp'_tm (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (tau_ty : forall _ : nat, ty) (tau_vl : forall _ : nat, vl) :
...
Qed.
Lemma renComp_vl (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (tau_ty : forall _ : nat, ty) (tau_vl : forall _ : nat, vl) (s : vl) :
  eq (subst_vl tau_ty tau_vl (ren_vl xi_ty xi_vl s))
...
exact (compRenSubst_vl xi_ty xi_vl tau_ty tau_vl _ _
                (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
Lemma renComp'_vl (xi_ty : forall _ : nat, nat) (xi_vl : forall _ : nat, nat)
  (tau_ty : forall _ : nat, ty) (tau_vl : forall _ : nat, vl) :
...
Qed.
Lemma compComp_tm (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (tau_ty : forall _ : nat, ty)
  (tau_vl : forall _ : nat, vl) (s : tm) :
  eq (subst_tm tau_ty tau_vl (subst_tm sigma_ty sigma_vl s))
...
exact (compSubstSubst_tm sigma_ty sigma_vl tau_ty tau_vl _ _
                (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
Lemma compComp'_tm (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (tau_ty : forall _ : nat, ty)
  (tau_vl : forall _ : nat, vl) :
...
Qed.
Lemma compComp_vl (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (tau_ty : forall _ : nat, ty)
  (tau_vl : forall _ : nat, vl) (s : vl) :
  eq (subst_vl tau_ty tau_vl (subst_vl sigma_ty sigma_vl s))
...
exact (compSubstSubst_vl sigma_ty sigma_vl tau_ty tau_vl _ _
                (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
Lemma compComp'_vl (sigma_ty : forall _ : nat, ty)
  (sigma_vl : forall _ : nat, vl) (tau_ty : forall _ : nat, ty)
  (tau_vl : forall _ : nat, vl) :
